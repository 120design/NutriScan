...
//    private(set) var paidVersionIsPurchased: Bool?
//    
...
//    
//    @MainActor
//    mutating func purchasePaidVersion() async throws -> PurchaseState {
...
//    
//    @MainActor
//    internal mutating func isPaidVersionPurchased() async -> Bool {
...
//    @MainActor
//    private mutating func isPurchased(productID: ProductID) async throws -> Bool {
...
//    @MainActor
//    private mutating func handleTransactions() -> Task<Void, Error> {
//        Task.detached {
...
//    @MainActor
//    private mutating func updatePurchasedIdentifiers(_ transaction: Transaction) async {
...
//}
//
//extension InAppPurchasesManager {
